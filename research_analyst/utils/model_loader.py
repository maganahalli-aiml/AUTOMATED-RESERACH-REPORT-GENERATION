...
class ModelLoader:
    ...
    def load_llm(self):
        ...
        provider_key = os.getenv("LLM_PROVIDER", "groq")  # Changed default to google
...
if __name__ == "__main__":
    ...
    # Test Embedding loading (without API call)
    print("🔄 Testing embedding model loading...")
    try:
        embeddings = loader.load_embeddings()
        print(f"✅ Embedding Model Loaded Successfully: {type(embeddings).__name__}")
    except Exception as e:
        print(f"❌ Embedding Model Loading Failed: {e}")

    # Test LLM loading (without API call)
    print("\n🔄 Testing LLM model loading...")
    try:
        llm = loader.load_llm()
        print(f"✅ LLM Model Loaded Successfully: {type(llm).__name__}")
    ...
    print("\nNote: To test actual API calls, ensure you have valid API keys in your .env file.")
