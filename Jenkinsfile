pipeline {
    ...
    environment {
        ...
        ACR_NAME = 'researchreportacr2580117'
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                cleanWs()
                git branch: 'main',
                    url: 'https://github.com/maganahalli-aiml/AUTOMATED-RESERACH-REPORT-GENERATION.git'
            }
        }
        ...
        stage('Run Tests') {
            steps {
                echo 'Running tests...'
                sh '''
                    python3 -c "from research_analyst.api.main import app; print('Imports successful')"
                '''
            }
        }
